...
let studentName = ["Fizza", "Neha", "Fatima", "Ariba", 4, 6, 5, undefined];
...
// Arrays of "String" //
let otherStudent = ["Fatiha", "Ammara", "Maidah", "Sonia", "Fizza", "Neha", "Fatima", "Ariba"];
console.log(otherStudent[0], otherStudent[4], otherStudent[17], otherStudent[7]);
// Arrays of "Number" //
let question = [1, 2, 3, 4, 5, 6, 7, 17];
console.log(question[0], question[7], question[3], question[11]);
// Arrays of "Boolean" //
let equation = [true, false, false, true, true];
